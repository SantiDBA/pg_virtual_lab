...
mkdir -p /opt/oracle/product/23ai/dbhomeFree/network/admin
touch /opt/oracle/product/23ai/dbhomeFree/network/admin/tnsnames.ora
chown oracle:oinstall /opt/oracle/product/23ai/dbhomeFree/network/admin/tnsnames.ora
